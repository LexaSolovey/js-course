...
function extractNameFromTemplate(value) {
  var splitCommand = value.split(" ");
    return splitCommand[1] + " " + splitCommand[2].substring(0, splitCommand[2].length -1);
}
...
var empty = " ", emptyTab = "\t";
var i = 0, j = 0;
while (empty == value.charAt(i) || emptyTab == value.charAt(i)) {
  i++
}
if (value.charAt(value.length-1) == empty || value.charAt(value.length-1) == emptyTab){
  j= value.length-1;
...
function removeFirstOccurrences(str, value) {
  var strBefore= str.substring(0, str.indexOf(value));
  var strAfter = str.substring(str.indexOf(value)+value.length);
...
var charGoriz ="─", strVertical = "│", charMid="", res = "", space =" ", strGoriz = "", Mid = "";
for (var i = 0; i < width-2; i++) {
  strGoriz+= charGoriz;
  charMid+=space;
}
var strFirst = "┌" + strGoriz + "┐\n";
var StrMid = strVertical + charMid + strVertical + "\n";
var strEnd = "└" + strGoriz + "┘\n";
for (var i = 0; i < height-2; i++) {
  Mid += StrMid;
}
return strFirst + Mid + strEnd;
}
